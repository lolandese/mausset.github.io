...
- Occasionalmente panificazione

Altrimenti potranno godersi un soggiorno rilassante in tutta intimità cullati dal canto degli uccelli o dallo scampanìo degli animali al pascolo.

### Attività di Gruppo

È previsto anche l'accesso a gruppi che intendano utilizzare gli spazi per fare dei corsi specifici, ad esempio:
- Astronomia (abbiamo un magnifico cielo non disturbato da fonti luminose vicine)
- Pittura
- Cucina
- Erboristica
- Yoga
- Lavorazione lana (feltro)
- E molti altri

A tutti diamo la nostra disponibilità di trasmettere le conoscenze acquisite nel corso di tanti anni vissuti a contatto con la Natura.
